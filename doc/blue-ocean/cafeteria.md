...
```mermaid
xychart-beta
    title "Strategy Canvas: Cafeteria Tradicional vs. Slow Coffee Shop"
    x-axis ["Preço", "Rapidez/Rotatividade", "Lanches Comuns", "Cafés Especiais (Origem)", "Métodos Manuais", "Ambiente de Trabalho (Tomadas/Wi-Fi)", "Comunidade"]
    y-axis "Nível de Oferta" 0 --> 10
    line [3, 9, 8, 1, 1, 2, 2]
    line [8, 3, 3, 10, 9, 10, 8]
```
