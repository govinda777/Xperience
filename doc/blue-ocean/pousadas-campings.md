...
```mermaid
xychart-beta
    title "Strategy Canvas: Hotel vs. Camping vs. Glamping"
    x-axis ["Preço", "Conforto Cama/Banho", "Contato Natureza", "Recepção/Staff", "TV a Cabo/Serviço Quarto", "Design/Instagramável", "Privacidade"]
    y-axis "Nível de Oferta" 0 --> 10
    line [8, 9, 2, 9, 9, 5, 4]
    line [2, 1, 10, 1, 0, 1, 3]
    line [7, 9, 9, 1, 2, 10, 10]
```
