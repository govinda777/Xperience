...
```mermaid
xychart-beta
    title "Strategy Canvas: Clínica Médica vs. Spa de Estética"
    x-axis ["Preço", "Dor/Invasivo", "Ambiente Hospitalar", "Tecnologia", "Planos de Assinatura", "Foco em Bem-Estar", "Tempo de Espera"]
    y-axis "Nível de Oferta" 0 --> 10
    line [9, 9, 10, 8, 2, 2, 8]
    line [6, 3, 1, 9, 10, 10, 2]
```
