...
When('preencho o formulário com informações válidas:', function (dataTable: any) {
...
When('eu tento enviar o formulário de contato sem preencher campos obrigatórios', function () {
  formData = {
    name: '',
    email: '',
    subject: '',
...
Then('as páginas devem carregar em menos de {int} segundos', function (maxSeconds: number) {
...
Then('todos os elementos interativos devem ser acessíveis via teclado', function () {
...
Then('os eventos importantes devem ser registrados:', function (dataTable: any) {
