import{w as e,M as t,p as i,R as o,i as a,r,a as s,x as n,q as c,e as l,o as w,h as d,d as p,j as u,s as m,E as h,O as v,C as g,t as f,k as b,A as y,T as x,u as k,b as C,g as S}from"./core-LFZjVNw3.js";import{c as R,n as N,r as O,o as T,U as A}from"./index-C6ASsYa9.js";import{proxy as W,subscribe as $}from"valtio/vanilla";import{subscribeKey as E}from"valtio/vanilla/utils";import"./wallet-BlXyhcsN.js";import"./router-BBtlhYrD.js";import"./vendor-BfOSbBEK.js";import"./index-BB0C2K8H.js";import"./analytics-CIB60-R_.js";const P=W({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=e({state:P,subscribe:e=>$(P,()=>e(P)),subscribeKey:(e,t)=>E(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===o.state.view||"SwitchNetwork"===o.state.view&&o.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void t.shake();await i.isSIWXCloseDisabled()?t.shake():t.close()}},D=a`
  :host {
    display: block;
