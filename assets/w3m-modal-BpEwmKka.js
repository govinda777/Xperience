import{w as e,p as t,s as i,q as o,M as a,t as r,R as s,i as n,r as c,a as l,x as w,u as d,e as p,o as u,h as m,d as h,j as v,v as g,E as f,O as b,C as y,y as x,k,A as C,T as S,z as R,b as N,g as O}from"./core-CrsCgPap.js";import{c as T,n as A,r as W,o as $,U as E}from"./index-Dib_8rsp.js";import"./wallet-oiYumMuh.js";import"./router-BBtlhYrD.js";import"./vendor-BfOSbBEK.js";import"./index-CXsk4O6e.js";import"./analytics-CIB60-R_.js";const P=t({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=e({state:P,subscribe:e=>o(P,()=>e(P)),subscribeKey:(e,t)=>i(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===s.state.view||"SwitchNetwork"===s.state.view&&s.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void a.shake();await r.isSIWXCloseDisabled()?a.shake():a.close()}},D=n`
  :host {
    display: block;
