...
export const PAYMENT_CONFIG: PaymentConfig = {
  ...
  webhookUrl: import.meta.env.VITE_WEBHOOK_URL || 'https://your-vercel-app.vercel.app/api/webhooks',
  apiUrl: import.meta.env.VITE_API_URL || 'https://your-vercel-app.vercel.app/api',
  security: {
...
export const PAYMENT_CONSTANTS = {
  ...
  // Limites de valor
  MIN_PAYMENT_BRL: 1.00,
  MAX_PAYMENT_BRL: 50000.00,
