...
const Feature: React.FC<FeatureProps> = ({ iconSrc, title, description }) => (
  <div className="flex flex-col items-center text-center">
    ...
    <p className="text-gray-600 max-w-[300px] text-base">{description}</p>
  </div>
);

const WhyXperience: React.FC = () => {
  const icons: Icons = {
    simplicidade: new URL(
      "/public/home/por-que-xperience--simplicidade.png",
      import.meta.url,
    ).href,
    facilidade: new URL(
      "/public/home/por-que-xperience--facilidade.png",
      import.meta.url,
    ).href,
    baixoCusto: new URL(
      "/public/home/por-que-xperience--baixo-custo.png",
      import.meta.url,
    ).href,
    resultados: new URL(
      "/public/home/por-que-xperience--resultados.png",
      import.meta.url,
    ).href,
    comunidade: new URL(
      "/public/home/por-que-xperience--comunidade.png",
      import.meta.url,
    ).href,
  };
  ...
  const bottomFeatures: Feature[] = [
    {
      ...
      title: "Resultados",
      description:
        "Ferramentas para melhorar seus resultados de forma eficiente.",
    },
    {
    ...
    <section className="bg-white py-16 md:py-32 flex items-center">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-[40px] font-bold mb-4">Por que a Xperience</h2>
          <p className="text-gray-600 text-lg max-w-[1000px] mx-auto">
            Você contará com várias ferramentas para proporcionar experiências
            inesquecíveis aos seus clientes e ao seu time. Pensamos na vivência
            de empreender como um todo.
          </p>
        </div>
