...
const WalletInfo: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="p-4 border rounded shadow-sm">Carregando dados da carteira...</div>;
  }
  ...
  if (!walletData) {
    return <div className="p-4 border rounded shadow-sm">Conecte-se para visualizar sua carteira</div>;
  }
