              ...
              <div className="mt-4 pt-4 border-t border-blue-200">
                <div className="bg-blue-100 rounded-lg p-3">
                  ...
                  {method.id === "github" && (
                    <div className="text-sm text-blue-800">
                      <p className="font-medium mb-1">
                        🐙 Patrocínio via GitHub
                      </p>
                      <p>
                        Pague de forma segura através do GitHub Sponsors.
                  ...
                  {method.id === "bitcoin" && (
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        Confirmação em até 30 minutos. Você economiza 5% no
                        valor total!
                      </p>
                    </div>
                  )}
                  ...
                  {method.id === "usdt" && (
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        Valor fixo em dólar. Confirmação em até 10 minutos.
                        Economize 3%!
                      </p>
                    </div>
                  )}
