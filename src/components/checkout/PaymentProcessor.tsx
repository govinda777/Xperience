    ...
    return (
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600">Aguarde enquanto configuramos seu pagamento</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="text-center mb-8">
        ...
        {timeRemaining > 0 && paymentStatus === 'pending' && (
          <p className="text-gray-600">
            Tempo restante: <span className="font-mono font-bold">{formatTime(timeRemaining)}</span>
          </p>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-bold">{formatCurrency(paymentResult.amount, paymentResult.currency)}</span>
          </div>
          <div className="flex justify-between">
      ...
      {paymentMethod === 'pix' && paymentResult.qrCode && (
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <div className="text-center mb-4">
            <QRCodeSVG value={paymentResult.qrCode} size={200} className="mx-auto" />
          </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => copyToClipboard(paymentResult.paymentAddress!, 'address')}
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => copyToClipboard(paymentResult.amount.toString(), 'amount')}
                  className="px-3 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors"
                >
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <ul className="text-sm text-orange-800 space-y-1">
                <li>• Envie exatamente {paymentResult.amount} BTC para o endereço acima</li>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => copyToClipboard(paymentResult.paymentAddress!, 'usdt-address')}
                  className="px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors"
                >
                  {copied === 'usdt-address' ? <CheckCircle className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
      ...
      {paymentMethod === 'github' && paymentResult.paymentUrl && (
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Pagamento via GitHub Sponsors</h3>
          
          <div className="space-y-4">
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-medium text-purple-900 mb-2">Como proceder:</h4>
