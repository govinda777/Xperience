export class OrderService {
    ...
    async createOrder(checkoutSession, paymentMethod) {
        try {
    ...
    async updatePaymentStatus(orderId, paymentStatus, paymentId, transactionHash) {
        try {
