...
describe("PaymentMethodSelector", () => {
    ...
    it("should render all payment methods", () => {
        render(_jsx(PaymentMethodSelector, { selected: "pix", onChange: mockOnChange, prices: mockPrices }));
    ...
    it("should highlight selected payment method", () => {
        render(_jsx(PaymentMethodSelector, { selected: "bitcoin", onChange: mockOnChange, prices: mockPrices }));
    ...
    it("should not call onChange when disabled", () => {
        render(_jsx(PaymentMethodSelector, { selected: "pix", onChange: mockOnChange, prices: mockPrices, disabled: true }));
        const bitcoinMethod = screen
            .getByText("Bitcoin")
            .closest('[class*="border-"]');
        fireEvent.click(bitcoinMethod);
    ...
    it("should show usdt specific information when usdt is selected", () => {
        render(_jsx(PaymentMethodSelector, { selected: "usdt", onChange: mockOnChange, prices: mockPrices }));
