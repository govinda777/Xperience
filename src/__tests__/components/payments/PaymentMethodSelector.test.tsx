...
describe("PaymentMethodSelector", () => {
  ...
  it("should show bitcoin specific information when bitcoin is selected", () => {
    ...
    expect(
      screen.getByText("🔒 Pagamento descentralizado"),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Confirmação em até 30 minutos/),
    ).toBeInTheDocument();
  });
  ...
  it("should display security information", () => {
    ...
    expect(
      screen.getByText(/Todos os pagamentos são processados de forma segura/),
    ).toBeInTheDocument();
  });
