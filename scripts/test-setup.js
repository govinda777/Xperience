...
const testUsers = [
  {
    ...
    wallet: {
      ...
      smartAccountAddress: '0xabcdef123456789abcdef123456789abcdef123456',
      balance: '1.5'
    }
  },
  {
    ...
    wallet: {
      ...
      smartAccountAddress: '0xfedcba987654321fedcba987654321fedcba987654',
      balance: '2.3'
    }
  }
];
...
const testPlans = [
  ...
  },
  {
    ...
    price: 497.00,
    currency: 'BRL',
    features: ['Acesso completo', 'Suporte prioritário', 'Mentoria 1:1', '60 dias de garantia']
  },
  {
    id: 'premium',
    name: 'Premium',
    price: 797.00,
    currency: 'BRL',
    features: ['Acesso vitalício', 'Suporte 24/7', 'Mentoria ilimitada', 'Garantia vitalícia']
  }
];
...
fs.writeFileSync(testTransactionsPath, JSON.stringify(testTransactions, null, 2));
